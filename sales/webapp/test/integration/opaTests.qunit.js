...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/sales/sales/test/integration/FirstJourney",
    "demo/sales/sales/test/integration/SalesOrdersListJourney",
    "demo/sales/sales/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});

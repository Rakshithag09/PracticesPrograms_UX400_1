...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/employeelist/list/test/integration/FirstJourney",
    "demo/employeelist/list/test/integration/EmployeeServiceListJourney",
    "demo/employeelist/list/test/integration/EmployeeServiceObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
